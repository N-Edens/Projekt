...
const map = L.map('map').setView([56.156820, 10.189205], 13);

map.attributionControl.addAttribution("Trafiktal 2013 - 2022 - Aarhus.dk");
...
function addLayer() {
    ...
    // Create new markers and polylines
...
function onClick() {
  ...
  // add the onClick function to both button's click event listeners
